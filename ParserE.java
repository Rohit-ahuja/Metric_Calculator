	...
	public static void main(String[] args) {
		...
		ParserE p=new ParserE();
			...
			System.out.print(e);
				...
				System.out.println("Total number of operators (N1) + cumulative adjoined:"+(p.countop+p.N1));
				System.out.println("Total number of operaterand (N2) + cumulative adjoined:"+(p.countor+p.N2));
